...
-- 3. Replace unique constraint: scope to conversation instead of journey
...
-- 4. Backfill: derive conversation_id from family_journeys.chat_history_id for existing rows
