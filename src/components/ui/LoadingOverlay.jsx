      ...
      <div style={{textAlign:'center',maxWidth:420,width:'100%',padding:'0 20px'}}>
        ...
        <div style={{position:'relative',width:160,height:160,margin:'0 auto 28px'}}>
          ...
          <div style={{position:'absolute',top:'50%',left:'50%',transform:'translate(-50%,-50%)',display:'flex',alignItems:'center',justifyContent:'center',animation:'iconPulse 2.4s ease-in-out infinite'}}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40.54 38.56" width="44" height="44" style={{transform:`rotate(${iconAngle}deg)`,transition:'transform 0.6s cubic-bezier(0.34,1.56,0.64,1)'}}><path fill={TEAL} d="M20.21,0h-11.7L0,8.48l7,10.78L0,30.05l8.52,8.52h12.76l19.26-19.3L21.28,0h-1.06ZM37.53,19.27l-16.26,16.29-.09-.09-5.7-5.7,6.06-9.34.75-1.16-.75-1.16-6.06-9.34,5.79-5.76.58.58,15.68,15.68Z"/><polygon fill={BG} points="15.48 8.77 21.54 18.11 22.29 19.26 21.54 20.42 15.48 29.76 21.18 35.46 21.28 35.56 37.53 19.27 21.85 3.59 21.27 3.01 15.48 8.77"/></svg>
          </div>
            {DOT_CONFIG.map((d,i)=>(
