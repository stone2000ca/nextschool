...
// [id] = conversation_id (scoped to the conversation, not journey)
export async function DELETE(
  ...
  try {
    ...
    // 1. Delete ChatShortlist records for this conversation + school
    ...
    // 2. Update SchoolJourney status to 'removed' (E29-004) — needs journey_id
    if (journey_id) {
    ...
    // 3. Atomically update ChatSession.shortlisted_count (E48-S4)
