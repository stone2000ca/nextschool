...
export default function Consultant() {
  ...
  useEffect(() => {
    ...
    // E16a-019: Check DB for upcoming event reminders within 48hrs
    fetch('/api/event-reminders')
      ...
      .then(reminders => {
        ...
        // Show toast for reminders within 48hrs
        ...
        // Clean expired reminders in background
  ...
  const checkAuth = async () => {
    try {
      ...
      if (authenticated) {
        ...
        // Dev mode: allow guest usage with hardcoded balance
